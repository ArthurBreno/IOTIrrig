...
public class AtividadeSobre extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_atividade_sobre);
        drawerLayout = findViewById(R.id.atividadeSobre);
